angular
  ...
  .controller("DashboardController", function ($scope, $timeout, AuthService) {
    ...
    // --- Dados Simulados COMPLETOS para o Síndico (com todos os cálculos) ---
    $scope.managerData = {
      stats: {
        units: 20,
        occupiedUnits: 18,
      ...
      recentAnnouncements: [ { title: "Reunião de Condomínio", date: "15/05/2025" }, { title: "Manutenção do Elevador", date: "20/05/2025" }, { title: "Limpeza da Caixa d'Água", date: "25/05/2025" } ],
      recentComplaints: [ { title: "Vazamento no Teto", unit: "202", date: "18/05/2025" }, { title: "Barulho após 22h", unit: "101", date: "17/05/2025" } ]
    };

    // --- Dados Simulados COMPLETOS para o Morador ---
    $scope.residentData = {
        stats: { pendingFees: 2, totalPendingAmount: 560, upcomingReservations: 1 },
        recentAnnouncements: [ { title: "Reunião de Condomínio", date: "15/05/2025" }, { title: "Manutenção do Elevador", date: "20/05/2025" } ],
        pendingTaxes: [ { description: "Taxa Condominial - Maio/2025", dueDate: "10/05/2025", amount: 350.00 }, { description: "Taxa Extra - Pintura Fachada", dueDate: "15/05/2025", amount: 210.00 } ],
        upcomingReservationsList: [ { area: "Salão de Festas", date: "28/05/2025", time: "18:00 - 22:00", status: "Aguardando", statusClass: "bg-yellow-100 text-yellow-800" } ],
        commonAreas: [ { id: 1, name: "Salão de Festas", available: true, image: "https://placehold.co/300x200/e2e8f0/1e293b?text=Sal%C3%A3o+de+Festas", description: "Capacidade para 50 pessoas." }, { id: 2, name: "Piscina", available: true, image: "https://placehold.co/300x200/e2e8f0/1e293b?text=Piscina", description: "Adulto e infantil." } ]
    };
